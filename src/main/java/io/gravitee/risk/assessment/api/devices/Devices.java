...
public class Devices {
    ...
    private List<String> existingDevices = new ArrayList<>();
    ...
    public Devices setCurrentDevice(String newDevice) {
        this.newDevice = newDevice;
        return this;
    }

    public Devices setExistingDevices(List<String> existingDevices) {
